...
class TimeSlot extends AppModel implements Comparable<TimeSlot> {
  ...
  DateTime get dateOfTimeSlot => DateTime(
    _dateOfTimeSlot.year,
    _dateOfTimeSlot.month,
    _dateOfTimeSlot.day,
  );
  ...
  int compareTo(TimeSlot other) {
    ...
    final enumIndexComparison = timeSlotType.index.compareTo(
      other.timeSlotType.index,
    );
    ...
    final otherDate = DateTime(
      other._dateOfTimeSlot.year,
      other._dateOfTimeSlot.month,
      other._dateOfTimeSlot.day,
    );
