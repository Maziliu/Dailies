    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: InkWell(
            ...
            onTap: () async {
              ...
              if (picked != null)
                _fileUploadViewModel.uploadedFiles.value = picked.files;
            },
          ),
        ),
        ValueListenableBuilder(
          ...
          builder: (context, files, clearButton) {
            return Column(
              ...
              children: [
                  ...
                  builder: (context, progressSnapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return FileWidget(
                          file: file,
                          fileUploadViewModel: _fileUploadViewModel,
                          progress: progress,
                        );
                      },
                    );
                ...
                if (files.isNotEmpty)
                  _buildActionButtons(
                    _fileUploadViewModel.requiresLLMParsing,
                    context,
                  ),
              ],
            );
          ...
          child: TextButton(
            onPressed: _fileUploadViewModel.clearUploadedFiles,
