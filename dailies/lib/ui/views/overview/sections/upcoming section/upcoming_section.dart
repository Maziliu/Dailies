...
class UpcomingSection extends StatelessWidget {
  ...
  const UpcomingSection({super.key, required EventsViewModel eventsViewModel})
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsetsGeometry.fromLTRB(8, 8, 8, 12),
          child: Text('Upcoming', style: context.textTheme.headlineLarge),
        ),
        SizedBox(
