...
class EventTypeSectionViewModel extends ChangeNotifier {
  ...
  TimeSlotType get eventTypeSelected => TimeSlotType.values[selectedTimeSlotIndex.value];
  ...
  TimeSlot constructTimeSlot(DateTime selectedDay) {
    ...
    switch (eventTypeSelected) {
      case TimeSlotType.Interval:
        startTime = DateTime(selectedDay.year, selectedDay.month, selectedDay.day, pickedStartTime.value.hour, pickedStartTime.value.minute);
        endTime = DateTime(selectedDay.year, selectedDay.month, selectedDay.day, pickedEndTime.value.hour, pickedEndTime.value.minute);
      case TimeSlotType.Deadline:
        endTime = DateTime(selectedDay.year, selectedDay.month, selectedDay.day, pickedDeadline.value.hour, pickedDeadline.value.minute);
      case TimeSlotType.Unspecified:
        startTime = null;
        endTime = null;
    }

    return TimeSlot.UnSaved(dateOfTimeSlot: normalizedSelectedDay, startTime: startTime, endTime: endTime);
  }
}
